 ...
 * ************************************************************************ */
$string['name'] = 'Nom'; 
$string['modulename'] = 'Onglets RÉCIT';
...
$string['menuname_help'] = 'Nom du menu';
...
$string['pluginname'] = 'Onglets RÉCIT';
$string['listactivity'] = "Liste des activités dans le menu";
$string['listactivity_help'] = "Écrire le nom des activités dans l'ordre souhaité, séparé par des virgules, sans espace. Le nom d'une activité doit être unique dans le cours";
$string['classrecit'] = 'Style';
$string['classrecit_help'] = 'Sélectionner le style souhaité';
